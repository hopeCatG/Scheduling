<template>
	<view class="padding-sm bg-white bg-height flex flex-direction justify-between">
		...
		<view class="relative">
			...
			<view class="flex margin-bottom-sm">
				<image class="absolute" v-if="params.state == 0" style="width: 200rpx;height: 200rpx;right: 10rpx;top: 10rpx;" src="../../../static/under_review.png" mode=""></image>
				<image class="absolute" v-if="params.state == 1" style="width: 200rpx;height: 200rpx;right: 10rpx;top: 10rpx;" src="../../../static/ReviewYEs.png" mode=""></image>
				<image class="absolute" v-if="params.state == 2" style="width: 200rpx;height: 200rpx;right: 10rpx;top: 10rpx;" src="../../../static/ReviewNo.png" mode=""></image>
				<view class="text-sm">
					申请类型：
				</view>
			...
			<view class="" v-if="radiovalue1 == '互调'">
				...
				<view class="flex margin-bottom-sm align-center">
					...
					<view class="disabled flex padding-lr-sm justify-between u-border radius padding-xs" style="flex: 1;">
						<div>{{youName}}</div>
					</view>
				</view>
				...
				<view class="flex margin-bottom-sm">
					...
					<view class="flex align-center" style="flex: 1;">
						<u--textarea v-model="IntermodulationObj.content" disabled="disabled" placeholder="请输入申请原因"></u--textarea>
					</view>
				</view>
				...
				<view class="flex margin-bottom-sm">
					...
					<view class="flex align-center" style="flex: 1;">
						<u--textarea v-model="IntermodulationObj.illustrate" disabled="disabled" placeholder="请输入申请原因"></u--textarea>
					</view>
				</view>
				<u-datetime-picker @click='test' :show="show_datetime" :closeOnClickOverlay="true" v-model="value_datetime" mode="time"
					@confirm='confirm_datetime' @cancel="cancelDateTime"></u-datetime-picker>
			</view>
			<!-- 公休 --> 
			<view v-else>
				<view class="flex margin-bottom-sm align-center">
				...
				<view class="flex margin-bottom-sm">
					...
					<view class="flex align-center" style="flex: 1;">
						<u--textarea v-model="ClosedObj.content" disabled="disabled" placeholder="请输入申请原因"></u--textarea>
					</view>
				</view>
				<view class="flex margin-bottom-sm">
					<view class="text-sm">
					...
					<view class="flex align-center" style="flex: 1;">
						<u--textarea v-model="ClosedObj.illustrate" disabled="disabled" placeholder="请输入申请原因"></u--textarea>
					</view>
				</view>
